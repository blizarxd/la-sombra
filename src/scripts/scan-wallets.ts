    ...
    try {
      ...
      db.update(walletProfiles)
        .set({
          ...
          liveTradeCount30d: metrics.liveTradeCount30d,
          liveResolvedCount30d: metrics.liveResolvedCount30d,
          liveWinRate30d: metrics.liveWinRate30d,
          liveRoi30d: metrics.liveRoi30d,
          sellCount30d: metrics.swing.sellCount,
          earlyExitRate: metrics.swing.earlyExitRate,
